...
int main() {
  ...
  std::cout << "\n"
            << YELLOW << "--- Test 1: Official Exercise Test ---" << RESET
            << std::endl;
  {
  ...
  std::cout << "\n"
            << YELLOW << "--- Test 2: MateriaSource Features ---" << RESET
            << std::endl;
  {
    ...
    if (ice1)
      std::cout << ice1->getType() << " ";
    if (cure1)
      std::cout << cure1->getType() << " ";
    if (ice2)
  ...
  std::cout << "\n"
            << YELLOW << "--- Test 3: Character Inventory ---" << RESET
            << std::endl;
  {
    Character hero("Hero");
    ...
    std::cout << "\nTrying to use unequipped slots (nothing should happen):"
              << std::endl;
  ...
  std::cout << "\n"
            << YELLOW << "--- Test 4: Copy Operations ---" << RESET
            << std::endl;
  {
            ...
            << YELLOW << "--- Test 6: Polymorphism ---" << RESET << std::endl;
  {
    ...
    std::cout << "Polymorphic character name: " << character->getName()
              << std::endl;
  ...
  std::cout << "\n"
            << YELLOW << "--- Test 7: Memory Management ---" << RESET
            << std::endl;
  {
    std::cout << "Creating and destroying objects to test memory management..."
              << std::endl;
